...
<head>
    <meta charset="UTF-8">
    <title>Videography Final Action</title>
...
<main class="max-w-4xl mx-auto px-6 py-12">
    <div class="bg-white shadow-xl rounded-xl p-8 space-y-6 border border-blue-300">
        <h1 class="text-3xl font-bold text-center text-blue-900 mb-4">🎥 Videography Final Approval</h1>
        ...
        <form method="POST" class="space-y-6 pt-6">
            <div>
                ...
                <textarea required name="acknow_remark" class="w-full mt-1 p-3 border rounded bg-gray-50" placeholder="Write your approval/rejection remarks here..."></textarea>
            </div>
