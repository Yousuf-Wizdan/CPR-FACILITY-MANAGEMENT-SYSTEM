<?php
    ...
    ) VALUES('$staffno','$staffno','$dept_code', 3 , 'Videograpghy' , '$event_details' , '$event_date' , '$place_of_event' , '$start_time' , '$service_hour' , '$contact' , '$staffno' , CURDATE() , 2 )";

    mysqli_query($conn , $sql);

    mysqli_close($conn);

    header('Location: videography.php?submitted=true');
    exit();
