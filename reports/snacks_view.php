...
<head>
    <meta charset="UTF-8">
    <title>Snacks Request Report View</title>
    <link href="../output.css" rel="stylesheet">
</head>
<body class="bg-gradient-to-br from-yellow-50 via-white to-orange-100 min-h-screen text-gray-800 font-sans">
<?php include('../components/navbar.php'); ?>

<main class="max-w-6xl mx-auto px-4 sm:px-8 py-10">
    <div class="bg-white rounded-3xl shadow-2xl border border-orange-200 p-10 transition hover:shadow-orange-300">
        <h1 class="text-4xl font-extrabold text-center text-orange-700 underline underline-offset-4 mb-10">
            🍪 Beverages & Snacks Request Report
        </h1>
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-[15px]">
            ...
            $fields = [
                ...
                '🍽️ Menu / Description' => $data['item_desc'],
                '🗓️ Event Date' => $data['event_date'] ?? '—',
                '📝 Event Detail' => $data['event_detail'] ?? '—',
            ];

            foreach ($fields as $label => $value) {
                echo "<div><span class='font-semibold text-gray-600'>{$label}:</span>
                        <div class='bg-orange-50 border border-orange-100 p-3 rounded mt-1 text-gray-800 whitespace-pre-wrap'>" . htmlspecialchars($value) . "</div></div>";
            }
            ?>
            ...
            <div>
                ...
                <div class="bg-orange-100 border border-orange-300 p-3 rounded mt-1 text-orange-800 font-medium whitespace-pre-wrap">
            ...
            <div>
                ...
                <div class="bg-orange-50 border border-orange-100 p-3 rounded mt-1 text-gray-800 whitespace-pre-wrap">
        ...
        <div class="mt-10 text-center">
            <a href="javascript:history.back()" class="inline-block bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-full shadow-lg transition-all">
                ⬅️ Back to Report
            </a>
        </div>
    </div>
