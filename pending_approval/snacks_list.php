...
// Fetch pending snacks requests
$query = "SELECT Req_id, add_dt, event_detail, event_date, event_place 
          FROM CPR_REQIUIS_MASTER 
          WHERE category_id = 6 AND leg_id = 2 
...
<head>
    <meta charset="UTF-8">
    <title>Beverages & Snacks Requests - Pending Approval</title>
...
<main class="max-w-6xl mx-auto px-6 py-12">
    <div class="bg-white shadow-2xl rounded-2xl border border-blue-300 p-8">
        <h1 class="text-3xl font-bold text-blue-900 mb-8 text-center">🍹 Beverages & Snacks - Pending Requests</h1>
        ...
        <div class="overflow-x-auto rounded-lg shadow-inner">
            <table class="min-w-full divide-y divide-gray-300 bg-white text-sm text-gray-800">
                ...
                <tbody class="divide-y divide-gray-100">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <a href="snacks_view.php?req_id=<?= $row['Req_id'] ?>"
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center py-6 text-gray-500">No pending snacks requests.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
