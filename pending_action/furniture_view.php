...
<head>
    <meta charset="UTF-8">
    <title>Furniture Approval</title>
...
<main class="max-w-4xl mx-auto px-6 py-12">
    <div class="bg-white shadow-xl rounded-xl p-8 space-y-6 border border-blue-300">
        <h1 class="text-3xl font-bold text-center text-blue-900 mb-4">🪑 Furniture Request Details</h1>
        ...
        <form method="POST" class="space-y-6 pt-6">
            <div>
                ...
                <textarea required name="acknow_remark" placeholder="Enter approval/rejection remark..." class="w-full mt-1 p-3 border rounded bg-gray-50"></textarea>
            </div>
