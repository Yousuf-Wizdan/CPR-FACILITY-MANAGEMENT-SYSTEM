...
<head>
    <meta charset="UTF-8">
    <title>Mementoes & Gifts Request</title>
...
<main class="max-w-4xl mx-auto px-6 py-12">
    <div class="bg-white rounded-xl shadow-2xl p-10 space-y-6 border border-yellow-300">
        <h1 class="text-3xl font-extrabold text-center text-yellow-900 mb-2">🎁 Mementoes & Gifts Request</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            ...
            <div>
                <label class="block text-gray-700 font-medium mb-1">Sub-Category (Type of Item)</label>
                <div class="bg-gray-50 border border-gray-300 rounded p-3"><?= htmlspecialchars($data['sub_category']) ?></div>
            </div>
            
            <div class="md:col-span-2">
                <label class="block text-gray-700 font-medium mb-1">Item Description</label>
