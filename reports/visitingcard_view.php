...
<head>
    <meta charset="UTF-8">
    <title>Visiting Card Request Report View</title>
    <link href="../output.css" rel="stylesheet">
</head>
<body class="bg-gradient-to-br from-emerald-50 via-white to-teal-100 min-h-screen text-gray-800 font-sans">
<?php include('../components/navbar.php'); ?>

<main class="max-w-6xl mx-auto px-4 sm:px-8 py-10">
    <div class="bg-white rounded-3xl shadow-2xl border border-emerald-200 p-10 hover:shadow-emerald-300 transition-all">
        <h1 class="text-4xl font-extrabold text-center text-emerald-700 underline underline-offset-4 mb-10">
            🪪 Visiting Card Request Report
        </h1>
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-[15px]">
            ...
            foreach ($fields as $label => $value) {
                echo "<div><span class='font-semibold text-gray-600'>{$label}:</span>
                        <div class='bg-emerald-50 border border-emerald-100 p-3 rounded mt-1 text-gray-800 whitespace-pre-wrap'>" . htmlspecialchars($value) . "</div></div>";
            }
            ?>
            <div>
            ...
            <div class="sm:col-span-2">
                ...
                <div class="bg-emerald-50 border border-emerald-100 p-3 rounded mt-1 text-gray-800 whitespace-pre-wrap">
            ...
            <div>
                ...
                <div class="bg-emerald-100 border border-emerald-300 p-3 rounded mt-1 text-emerald-800 font-medium whitespace-pre-wrap">
        ...
        <div class="mt-10 text-center">
            <a href="javascript:history.back()" class="inline-block bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-full shadow-lg transition-all">
                ⬅️ Back to Report
            </a>
        </div>
    </div>
