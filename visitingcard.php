...
<body class="bg-gradient-to-br from-blue-100 to-green-100 min-h-screen font-sans">
    ...
    <div class="max-w-3xl mx-auto py-12 px-6">
        <div class="bg-white shadow-xl rounded-xl p-8">
            ...
            <h1 class="text-3xl font-bold text-center text-blue-900 mb-6">💼 Visiting Card Request</h1>

            <form action="submit_visitingcard.php" method="POST" enctype="multipart/form-data" class="space-y-6">
