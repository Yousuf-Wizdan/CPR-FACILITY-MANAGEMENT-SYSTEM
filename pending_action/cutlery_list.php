...
$query = "SELECT Req_id, add_dt, cateory_desc, sub_category, item_desc 
          FROM CPR_REQIUIS_MASTER 
          WHERE category_id = 5 AND leg_id IN (1, 4)";
...
<head>
    <meta charset="UTF-8">
    <title>Pending Cutlery Requests</title>
...
<main class="max-w-6xl mx-auto px-6 py-12">
    <div class="bg-white rounded-xl shadow-xl border border-blue-300 p-10">
        <h1 class="text-3xl font-extrabold text-center text-blue-900  mb-10">Pending Cutlery Requests</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2">
                            <a href="cutlery_view.php?req_id=<?= $row['Req_id'] ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-1 rounded-full text-sm font-medium shadow"> View</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        <?php else: ?>
            <p class="text-center text-gray-500 font-semibold">No pending cutlery requests found.</p>
        <?php endif; ?>
    </div>
</main>
</body>
