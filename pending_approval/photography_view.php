...
<body class="bg-gradient-to-br from-pink-100 via-white to-indigo-100 min-h-screen font-sans">
<?php include('../components/navbar.php'); ?>

<main class="max-w-4xl mx-auto px-6 py-12">
    <div class="bg-white rounded-xl shadow-2xl p-10 space-y-6 border border-indigo-300">
        <h1 class="text-3xl font-extrabold text-center text-indigo-900 mb-2">📷 Photography Request</h1>
