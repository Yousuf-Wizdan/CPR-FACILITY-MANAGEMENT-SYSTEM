...
<head>
    <meta charset="UTF-8">
    <title>Videography Request Report View</title>
    <link href="../output.css" rel="stylesheet">
</head>
<body class="bg-gradient-to-br from-indigo-50 via-white to-sky-100 min-h-screen text-gray-800 font-sans">
<?php include('../components/navbar.php'); ?>

<main class="max-w-6xl mx-auto px-4 sm:px-8 py-10">
    <div class="bg-white rounded-3xl shadow-2xl border border-indigo-200 p-10 transition hover:shadow-indigo-300">
        <h1 class="text-4xl font-extrabold text-center text-indigo-700 underline underline-offset-4 mb-10">
            🎥 Videography Request Report
        </h1>
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-[15px]">
            ...
            foreach ($fields as $label => $value) {
                echo "<div><span class='font-semibold text-gray-600'>{$label}:</span>
                        <div class='bg-indigo-50 border border-indigo-100 p-3 rounded mt-1 text-gray-800 whitespace-pre-wrap'>" . htmlspecialchars($value) . "</div></div>";
            }
            ?>
            ...
            <div>
                ...
                <div class="bg-green-50 border border-green-200 p-3 rounded mt-1 text-indigo-700 font-medium whitespace-pre-wrap">
            ...
            <div>
                ...
                <div class="bg-indigo-50 border border-indigo-100 p-3 rounded mt-1 text-gray-800 whitespace-pre-wrap">
        ...
        <div class="mt-10 text-center">
            <a href="javascript:history.back()" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-full shadow-lg transition-all">
                ⬅️ Back to Report
            </a>
        </div>
    </div>
